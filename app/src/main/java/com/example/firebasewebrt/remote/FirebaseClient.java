package com.example.firebasewebrt.remote;
...
public class FirebaseClient {
    ...
    public void login(String userName, SuccesCallBack callBack){
    ...
    public void sendMessageToOtherUser(DataModel dataModel, ErrrorCallBack errorCallBack){
